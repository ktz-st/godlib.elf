...
enum
{
	...
	eDEBUGCHANNEL_DEST_HATARI = 1<<4,
	eDEBUGCHANNEL_DEST_ALL    = (eDEBUGCHANNEL_DEST_HATARI | eDEBUGCHANNEL_DEST_STEEM | eDEBUGCHANNEL_DEST_SCREEN | eDEBUGCHANNEL_DEST_FILE | eDEBUGCHANNEL_DEST_CLI )
};
