...
**************************************************************************************
	...
	XDEF	Graphic_4BP_Blit
	XDEF	Graphic_4BP_ClearScreen
	XDEF	Graphic_4BP_CopyScreen
	XDEF	Graphic_4BP_DrawBox
	XDEF	Graphic_4BP_DrawLine
	XDEF	Graphic_4BP_DrawPixel
	XDEF	Graphic_4BP_DrawSprite
	XDEF	Graphic_4BP_DrawTri
	XDEF	Graphic_4BP_DrawQuad

	XDEF	Graphic_4BP_Blit_Clip
	XDEF	Graphic_4BP_ClearScreen_Clip
	XDEF	Graphic_4BP_CopyScreen_Clip
	XDEF	Graphic_4BP_DrawBox_Clip
	XDEF	Graphic_4BP_DrawLine_Clip
	XDEF	Graphic_4BP_DrawPixel_Clip
	XDEF	Graphic_4BP_DrawSprite_Clip
	XDEF	Graphic_4BP_DrawTri_Clip
	XDEF	Graphic_4BP_DrawQuad_Clip

	XDEF	gGraphicBlitRout
...
Graphic_4BP_DrawPixel_Go:
	...
	bcc.s	.nbp0								; Not Set
	or.w	d1,0(a1)							; Draw To Plane0
.nbp0:
	lsr.w	#1,d0								; Check Bit 1
	bcc.s	.nbp1								; Not Set
	or.w	d1,2(a1)							; Draw To Plane 1
.nbp1:
	lsr.w	#1,d0								; Check Bit 2
	bcc.s	.nbp2								; Not Set
	or.w	d1,4(a1)							; Draw To Plane 2
.nbp2:
	lsr.w	#1,d0								; Check Bit 3
	bcc.s	.nbp3								; Not Set
	or.w	d1,6(a1)							; Draw To Plane 3
.nbp3:
