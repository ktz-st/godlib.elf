...
**************************************************************************************
	...
	XDEF		IKBD_GetHandler
	XDEF		IKBD_SetHandler

	XDEF		IKBD_GetMidiBytesWaiting
	XDEF		IKBD_GetKbdBytesWaiting
	XDEF		IKBD_PopMidiByte
	XDEF		IKBD_PopKbdByte

	XDEF		IKBD_Flush
	XDEF		IKBD_FlushGemdos
	XDEF		IKBD_SendCmd

	XDEF		IKBD_MainHandler
	XDEF		IKBD_PowerpadHandler
	XDEF		IKBD_ReadPowerpadA
	XDEF		IKBD_ReadPowerpadB

	XDEF		IKBD_ReadPadMatrixA
	XDEF		IKBD_ReadPadMatrixB

	XDEF		IKBD_InitTosLink

	XDEF	IKBD_InstallTrap13
	XDEF	IKBD_RestoreTrap13
...
sIKBD_pUnshiftTable:   rs.l    1
sIKBD_pShiftTable:     rs.l    1
sIKBD_pCapsTable:      rs.l    1

sIKBD_MidiHead:        rs.w    1
sIKBD_MidiTail:        rs.w    1

sIKBD_KbdHead:         rs.w    1
sIKBD_KbdTail:         rs.w    1

sIKBD_KbdOverflowFlag: rs.b    1
sIKBD_MidiOverflowFlag:rs.b    1

sIKBD_Joy0Packet:      rs.b    1
sIKBD_Joy1Packet:      rs.b    1
sIKBD_MouseMovedFlag:  rs.b    1
sIKBD_MouseKeys:       rs.b    1

sIKBD_KeyPressedFlag:  rs.b    1
sIKBD_LastKeypress:    rs.b    1

sIKBD_MouseX:          rs.w    1
sIKBD_MouseY:          rs.w    1

sIKBD_TeamTapActiveFlag: rs.b  1
sIKBD_TeamTapActiveBits: rs.b  1

sIKBD_Pad0Dir:         rs.b    1
sIKBD_Pad1Dir:         rs.b    1
sIKBD_Pad0Key:         rs.w    1
sIKBD_Pad1Key:         rs.w    1

sIKBD_TeamTapDirs:     rs.b    8
sIKBD_TeamTapKeys:     rs.w    8

sIKBD_KbdPressTable:   rs.b    128
sIKBD_MidiBuffer:      rs.b    2048
sIKBD_KbdBuffer:       rs.b    2048

sIKBD_StatusData:      rs.b    8
sIKBD_TimeOfDay:       rs.b    6
sIKBD_Temp:            rs.b    2
...
.notALT:
	...
	moveq	#0,d0							; clear d0
	btst	#3,$484.w						; check bit 3 of CONTERM
...
.write:
	...
	btst	#0,d0								; should we set right shift?
...
.noShiftRight:
	...
	btst	#1,d0								; should we set left shift?
