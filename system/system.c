...
* ACTION   : determines blitter type of system
* CREATION : 24.03.00 PNK
*-----------------------------------------------------------------------------------*/
...
eSYSTEM_BLT	System_CalcBLT()
{
	...
	{
		lBlt = (eSYSTEM_BLT)((Xbios_Blitmode( -1 )) & 2) >> 1;
	}
	else
	{
		lBlt = BLT_NONE;
...
* ACTION   : sets emulator type of system
* CREATION : 24.03.00 PNK
*-----------------------------------------------------------------------------------*/
...
* ACTION   : returns emulator type of system
* CREATION : 24.03.00 PNK
*-----------------------------------------------------------------------------------*/
...
* ACTION   : determines emulator type of system
* CREATION : 24.03.00 PNK
*-----------------------------------------------------------------------------------*/
...
* ACTION   : returns name string of emulator type of system
* CREATION : 24.03.00 PNK
*-----------------------------------------------------------------------------------*/
...
* ACTION   : sets memory type of system
* CREATION : 24.03.00 PNK
*-----------------------------------------------------------------------------------*/
...
* ACTION   : returns memory type of system
* CREATION : 24.03.00 PNK
*-----------------------------------------------------------------------------------*/
...
* ACTION   : determines memory type of system
* CREATION : 24.03.00 PNK
*-----------------------------------------------------------------------------------*/
